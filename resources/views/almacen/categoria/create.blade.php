                ...
                <div class="card-body">
                    ...
                    <!-- /.card-body -->
                        ...
                        <div class="card-footer">
                            ...
                            <button onclick="window.location.href='http://localhost/puntoventaLaravel-kevinflores/public/almacen/categoria'" type="reset" class="btn btn-danger me-1 mb-1">Cancelar</button>
                        </div>
                </div>
            </form>
        </div>
